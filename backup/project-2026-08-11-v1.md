...
- 마지막 업데이트: 2026-08-11
- 현재 단계: MVP 구현 완료, 실제 TGAM 장비 통합 검증 전
- 저장소: `FUSE-Lab-2026/interFace-interSignal`
- 기준 브랜치: `main`
- 문서 역할: 데이터 규격, MVP 범위, 구현 상태, 검증 상태를 관리하는 단일 기준 문서
- 이전 문서: `backup/project-2026-08-11-legacy-tgam-eeg-webviz.md`
...
| 파일 | 책임 |
|---|---|
| `public/index.html` | 페이지 entry, 6개 visibility checkbox |
| `public/serial-source.js` | Web Serial 연결/해제, byte 수신, packet dispatch |
| `public/tgam-parser.js` | ThinkGear framing, checksum, payload parsing |
| `public/derived-signals.js` | 카드 01-03 계산과 FFT |
| `public/sketch.js` | live data buffer, 반응형 layout, 카드 01-06 p5 rendering |
| `public/style.css` | 페이지, checkbox, serial button style |
...
- 현재 자동 테스트: parser packet/split/checksum, mock Web Serial lifecycle 및
  raw/state/band packet, 6-card page structure
